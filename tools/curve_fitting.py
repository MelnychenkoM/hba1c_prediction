...
def create_params_pseudo_voigt(x_values, y_values, peaks):
    ...
    for i, peak in enumerate(peaks):
        ...
        upper_bound.extend([
            ...
            100,                 # Upper bound for FWHM (gamma)
            30,                  # Upper bound for A
...
def fit_pseudo_voigt(x_values, y_values, peaks, fig_show=False, wavenumber=False, residuals=False):
    ...
    params_df = pd.DataFrame({
        ...
        "wavenumber": params[::4],
        "gamma": params[1::4],
        "amplitude": params[2::4],
        "eta": params[3::4],
        "FWHM": fwhms,
        "area": areas,
        "delta": x_values[peaks] - params[::4],
    })
...
# def fit_gauss(x_values, y_values, peaks, fig_show=False, wavenumber=False, residuals=False):
#     """
#     Curve fitting using jaxfit.
#     """
#     if wavenumber:
...
#     bounds, initial_guess = create_params_gauss(x_values, y_values, peaks)
    
#     jcf = CurveFit()
#     params, pcov = jcf.curve_fit(combined_gaussian, x_values, y_values, p0=initial_guess, bounds=bounds, ftol=1e-12)

#     predicted = combined_gaussian(x_values, *params)
...
#         #print(params[i:i+3])
#         fig.add_trace(go.Scatter(x=x_values, 
#                                  y=combined_gaussian(x_values, *params[i:i+3], base), 
#                                  mode='lines', 
#                                  line=dict(width=1, dash='dash'),
#                                  name=str(round(params[i], 2))))
...
#         "peak_found": x_values[peaks],
#         "wavenumber": params[::3],
#         "delta": x_values[peaks] - params[::3],
#         "sigma": params[1::3],
#         "amplitude": params[2::3],
#     })
